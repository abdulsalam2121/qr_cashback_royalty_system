...
-- AddForeignKey
ALTER TABLE "payment_links" ADD CONSTRAINT "payment_links_purchaseTransactionId_fkey" FOREIGN KEY ("purchaseTransactionId") REFERENCES "purchase_transactions"("id") ON DELETE CASCADE ON UPDATE CASCADE;
