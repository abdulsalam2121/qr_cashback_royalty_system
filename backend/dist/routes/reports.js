...
router.get('/dashboard', auth, rbac(['tenant_admin', 'cashier']), asyncHandler(async (req, res) => {
    ...
    const [previousMonthCustomers, previousMonthCards, previousMonthTransactions, previousMonthEarnTransactions, previousMonthRedeemTransactions, currentMonthCustomers, currentMonthCards, currentMonthTransactions, currentMonthEarnTransactions, currentMonthRedeemTransactions] = await Promise.all([
    ...
    const cashbackIssuedTrend = calculateTrend(currentMonthEarnTransactions._sum.cashbackCents || 0, previousMonthEarnTransactions._sum.cashbackCents || 0);
    const cashbackRedeemedTrend = calculateTrend(currentMonthRedeemTransactions._sum.amountCents || 0, previousMonthRedeemTransactions._sum.amountCents || 0);
    res.json({
        totalCustomers,
        totalCards,
        totalTransactions,
